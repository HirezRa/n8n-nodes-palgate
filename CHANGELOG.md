...
### Changed
- Remove "Syncing with a Postman collection" section from README (do not publish internal workflow in public docs)
- Remove links to internal docs (POSTMAN_SYNC.md, DELETE_OPERATION.md, AUTOMATED_TEST_REPORT.md) from README

## [1.0.35] - 2026-02-05

### Changed
- Point homepage in package.json to GitHub repo: https://github.com/HirezRa/n8n-nodes-palgate
